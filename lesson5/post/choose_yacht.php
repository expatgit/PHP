    ...
    <form method="post" action="form_handler.php">
        ...
        <fieldset>
            ...
            <div>
                ...
                <input type="text" id="name" name="user_name"> // name - ключ для массива
            </div>
        ...
        <fieldset>
            ...
            <div>
                ...
                <select id="companies" name="company">
                    ...
                    <option value="<?php echo $company['id'] ?>"> // данные на сервер придут в виде строки
        ...
        <fieldset>
            ...
            <div>
                ...
                <div><label><input value="email" type="checkbox" name="contacts[]"> E-mail</label></div> <!-- value отправляет данные в человеческом виде-->
            </div>
        </fieldset>
